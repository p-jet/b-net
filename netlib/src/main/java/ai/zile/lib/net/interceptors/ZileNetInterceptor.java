package ai.zile.lib.net.interceptors;

import android.support.annotation.NonNull;

import ai.zile.lib.net.config.Configurator;
import ai.zile.lib.net.utils.ZileNetLogger;
...
public class ZileNetInterceptor extends BaseNetInterceptor {

    private final static String TAG = ZileNetInterceptor.class.getSimpleName();
    ...
    public Response intercept(@NonNull Interceptor.Chain chain) throws IOException {
        ...
        if (!bodyEncoded(response.headers())) {
            ...
            ZileNetLogger.i(TAG, request.toString() + "\n" +
