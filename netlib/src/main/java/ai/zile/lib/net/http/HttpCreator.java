...
import ai.zile.lib.net.utils.ResourceTools;
...
public class HttpCreator {
    ...
    private static final class OKHttpHolder {
        ...
        private static final ArrayList<Interceptor> INTERCEPTORS = ZileNet.getConfiguration(ConfigKeys.INTERCEPTOR);
    ...
    private static final class RetrofitHolder {
        private static final String BASE_URL = ZileNet.getConfiguration(ConfigKeys.API_HOST);
...
//              .addConverterFactory(ScalarsConverterFactory.create())
    ...
    private static InputStream trustedCertificatesInputStream() {
        String cer = ZileNet.getConfiguration(ConfigKeys.HTTPS_CER);
        String comodoRsaCertificationAuthority = ResourceTools.readAssets2String(ZileNet.getApp(), cer);
        return new Buffer()
