...
import ai.zile.lib.net.filter.RespFilterManager;
import ai.zile.lib.net.filter.data.RespData;
import ai.zile.lib.net.filter.data.RespEntity;
import ai.zile.lib.net.filter.data.RespError;
import ai.zile.lib.net.http.ErrorStatus;

import io.reactivex.Observer;
import io.reactivex.disposables.Disposable;

public abstract class ZileNetObserver<T> implements Observer<T> {
