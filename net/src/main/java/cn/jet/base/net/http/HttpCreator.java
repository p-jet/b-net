...
import cn.jet.base.net.utils.ResourceTools;
...
public class HttpCreator {
    ...
    private static final class OKHttpHolder {
        ...
        private static final ArrayList<Interceptor> INTERCEPTORS = JetNet.getConfiguration(ConfigKeys.INTERCEPTOR);
    ...
    private static final class RetrofitHolder {
        private static final String BASE_URL = JetNet.getConfiguration(ConfigKeys.API_HOST);
...
//              .addConverterFactory(ScalarsConverterFactory.create())
    ...
    private static InputStream trustedCertificatesInputStream() {
        String cer = JetNet.getConfiguration(ConfigKeys.HTTPS_CER);
        String comodoRsaCertificationAuthority = ResourceTools.readAssets2String(JetNet.getApp(), cer);
        return new Buffer()
